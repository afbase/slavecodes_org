+++
title = "Primary Source Transcriptions"
description = "Full transcriptions and translations of three New Orleans slave trade documents, 1807–1827"
...
For historical analysis and context, see the [main page](@/slave-trade-map/_index.md).

---

## Document 1: Sale of the Enslaved Woman Marie (May 17, 1817)

{{ image_with_caption(url="marie-sale.jpeg", caption="Notarial act: Sale of Marie by Eulalie Bayeron to Jean Antoine Bernard. New Orleans, 17 May 1817.", credit="New Orleans Notarial Archives") }}
...
*[Signatures:]*
Anté. e Bernard — *[mark of]* Eulalie Bayeron ✝
Chabey — M[ar]c Lafitte, not[aire] pub[lic]
J[acque]s Joly
...
**Key terms:**
- *f.C.L.* — *femme de Couleur Libre*, free woman of color.
- *négrette* — diminutive/feminine form; used for Marie throughout the act.
- *garantie* — warranty. The seller warrants that Marie is her property to sell, free of third-party claims and mortgage debts, and without redhibitory defects.
- *vice ou maladie rédhibitoire* — redhibitory vice or disease. Under Louisiana civil law, a buyer could return a purchased enslaved person within a specified period if they discovered undisclosed defects.
- *piastres* — Spanish silver dollars, the standard currency. 725 piastres was a significant sum.
...
## Document 2: Petition to the City Court Regarding the Seizure of Victor (filed ca. May 31, 1810)
...
- *Shériff* for *shérif* — a Gallicized rendering of the English word "sheriff"
- *bossal* for *bozal* — from the Spanish, meaning an African-born enslaved person not yet acculturated to colonial society
- *Piastres* — the standard monetary unit in colonial Louisiana, equivalent to the Spanish silver dollar
- *escalin* — a small coin worth a fraction of a piastre; derived from the Dutch *schelling*

**Key persons:**
- **Eulalie Bayeron**: Free woman of color (*fille de couleur libre*). The surname appears in variant spellings across documents — D'Ayeron in some versions, Bayeron in the notarial sale.
- **Victor**: Enslaved man, described as *bossal* (recently arrived from Africa). Purchased at Santiago de Cuba in 1807.
- **Sr Dupuis**: Seller of Victor in Santiago de Cuba. No further identification.
- **B. Cénas**: Blase Cénas, Sheriff of the 1st District of the Superior Court of the Territory of Orleans.
- **Joseph Gelliés**: Creditor who obtained the writ of attachment against Pierre Liquet's property.
- **Pierre Liquet**: Debtor. Also appears in Document 1 as the person from whom Eulalie acquired Marie in 1815, and in Document 3 as the owner shipping Francoise in 1827.
- **Seghers**: Attorney who signed the petition on Eulalie's behalf.
...
## Document 3: Manifest of Slaves — Schooner Sémillante (May 29, 1827)

{{ image_with_caption(url="ship-manifest.jpeg", caption="Manifest of Slaves on board the Schooner Sémillante, bound from New Orleans for the Port of Bay Saint Louis. May 29, 1827.", credit="New Orleans Notarial Archives") }}
...
**Column analysis:**
- **NAMES**: Only a first name is recorded. Enslaved people were typically denied surnames in official documents.
- **CLASS**: "Black" in this context refers to skin color classification, not free/enslaved status (which was assumed by the document's nature).
- **SHIPPERS or OWNERS**: Pierre Liquet of New Orleans — the same Pierre Liquet who appears in Documents 1 and 2.
...
- **Original spelling and orthography are preserved.** The documents reflect early 19th-century Louisiana French and English usage. No corrections have been made to spelling, grammar, or punctuation.
- **Illegible passages** are marked with *[?]*.
- **Abbreviated words** are expanded in brackets where the expansion is certain: S[ieu]r = Sieur, M[aît]re = Maître.
- **The ship manifest** is a combination of printed form text and handwritten entries.
- **Conventions:** `[?]` marks uncertain readings. `[...]` marks illegible text. `[struck through]` marks crossed-out text in the original. Editorial notes are in *[italics in brackets]*.
- **Translations** aim for accuracy over elegance. Legal and technical terms are translated as closely as possible to their English legal equivalents.
